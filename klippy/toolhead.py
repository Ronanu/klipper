...
BUFFER_TIME_LOW = 0.1  # 1.0
BUFFER_TIME_HIGH = 0.2  # 2.0
BUFFER_TIME_START = 0.025  # 0.250
BGFLUSH_LOW_TIME = 0.02 # 0.200
BGFLUSH_BATCH_TIME = 0.02 # 0.200
BGFLUSH_EXTRA_TIME = 0.025 # 0.250
MIN_KIN_TIME = 0.01 #  0.100
MOVE_BATCH_TIME = 0.05 #  0.500
STEPCOMPRESS_FLUSH_TIME = 0.050
SDS_CHECK_TIME = 0.001 # step+dir+step filter in stepcompress.c
MOVE_HISTORY_EXPIRE = 3  # 30.
